...
Rain _$RainFromJson(Map<String, dynamic> json) => new Rain(json['3h'] as int);
...
Snow _$SnowFromJson(Map<String, dynamic> json) => new Snow(json['3h'] as int);
...
WeatherModel _$WeatherModelFromJson(
